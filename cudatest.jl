...
shmem = sizeof(Float32) * ((4 * 4) + 32 * (12 * 12))
...
function benchmark_fil_trans()
    NVTX.@range "kernel" begin
        @cuda blocks=(2,18 * 18,64) threads=(32,4,4) shmem=shmem maxregs=64 img_trans_kernel(img,fil_trans,dest,18)
#         @cuda blocks=(2,18 * 18,64) threads=(32,4,4) shmem=shmem maxregs=64 img_trans_kernel(img,fil_trans,dest,144,144,64)
